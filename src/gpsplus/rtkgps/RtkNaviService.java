...
import gpsplus.rtkgps.settings.RoverSettings;
...
import gpsplus.rtklib.BuildConfig;

import gpsplus.rtklib.R;
...
public class RtkNaviService extends IntentService {
    ...
    public static final String ACTION_START = "main.java.com.rtkgps.RtkNaviService.START";
    public static final String ACTION_STOP = "main.java.com.rtkgps.RtkNaviService.STOP";
    public static final String ACTION_STORE_POINT = "main.java.com.rtkgps.RtkNaviService.STORE_POINT";
    public static final String EXTRA_SESSION_CODE = "main.java.com.rtkgps.RtkNaviService.SESSION_CODE";
    public static final String EXTRA_POINT_NAME = "main.java.com.rtkgps.RtkNaviService.POINT_NAME";
    ...
    private void addPointToCRW(String pointName) {
        ...
        RtkCommon.Position3d roverEcefPos = currentSolution.getPosition();
    ...
    public void processStart() {
        Log.d(TAG, "RtkNaviService process started");
    ...
    private void startUsb() {
        ...
        {
            final RtkServerSettings.TransportSettings roverSettings = settings.getInputRover().getTransportSettings();
            RoverSettings.UsbSettings usbSettings = (RoverSettings.UsbSettings) roverSettings;
