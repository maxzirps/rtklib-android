...
public class ProcessingOptions {
    ...
    public RtkCommon.Position3d getBaseStationPosition() {
        return new RtkCommon.Position3d(mNative.baseX, mNative.baseY, mNative.baseZ);
    }

    public void setBasePosition(StationPositionType type, RtkCommon.Position3d ecefPos) {
    ...
    public RtkCommon.Position3d getRoverPosition() {
        return new RtkCommon.Position3d(mNative.ruX, mNative.ruY, mNative.ruZ);
    }

    public void setRoverPosition(StationPositionType type, RtkCommon.Position3d ecefPos) {
