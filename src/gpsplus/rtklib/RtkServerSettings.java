...
public class RtkServerSettings {
    ...
    public static class InputStream {
        ...
        public InputStream() {
            ...
            mReceiverOption = "";
            mNmeaRequestType = 0;
            mTransmittedPos = new RtkCommon.Position3d();
            mStationPosType = StationPositionType.RTCM_POS;
            mStationPos = new RtkCommon.Position3d();
        }
         ...
         */
        public InputStream setTransmitNmeaPosition(int type, RtkCommon.Position3d pos) {
        ...
        public RtkCommon.Position3d getTransmittedPosition() {
            return new RtkCommon.Position3d(mTransmittedPos);
        }
         ...
         * @return
         */
        public InputStream setStationPos(StationPositionType type, RtkCommon.Position3d ecefPos) {
        ...
        public RtkCommon.Position3d getStationPosition() {
            return new RtkCommon.Position3d(mStationPos);
        }
