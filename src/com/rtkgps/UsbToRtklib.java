...
public class UsbToRtklib {
    ...
    public static final String ACTION_USB_DEVICE_ATTACHED = "main.java.com.rtkgps.UsbToRtklib.ACTION_USB_DEVICE_ATTACHED";
    ...
    private class UsbReceiver {
        ...
        static final String ACTION_USB_PERMISSION = "main.java.com.rtkgps.usb.UsbReceiver.USB_PERMISSION";
        ...
        private UsbSerialController probeDevice(UsbDevice d) {
            ...
            try {
                ...
                return c;
            }catch(UsbSerialController.UsbControllerException ignore) { }
